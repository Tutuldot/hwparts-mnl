            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" step="0.01" min="0" max="100" name="withholding_tax_rate" class="form-control" placeholder="e.g. 1.00 or 2.00" value="<?= old('withholding_tax_rate', number_format($customer['withholding_tax_rate'] ?? 1.00, 2)) ?>">
